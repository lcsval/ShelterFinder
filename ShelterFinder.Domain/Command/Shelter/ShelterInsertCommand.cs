...
{
    public class ShelterInsertCommand : ShelterBaseCommand
    {
        public InlineValidator<T> GetValidator<T>() where T : ShelterInsertCommand
        {
        ...
        {
            return GetValidator<ShelterInsertCommand>().Validate(this);
        }
    }
}
